...
/*   Updated: 2025/09/25 15:16:12 by nmattos-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int			handle_portal(t_level *level, t_playerdata *p,
						int y, int x);
...
static void			calculate_door_ray(t_point *map, t_raycast *ray,
						t_level *lvl);
